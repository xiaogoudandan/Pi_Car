...
public class TrashCanView extends AppCompatImageView {
    ...
    public void setDefaultIcon(Drawable drawable) {
        mDefaultDrawable = setIconColor(drawable, getColorPrimary(getContext()));
    ...
    public void setOnHoverIcon(Drawable drawable) {
        mOnHoverDrawable = setIconColor(drawable, getColorPrimary(getContext()));
    ...
    public Drawable setIconColor(Drawable drawable, int color) {
